        ...
        String situacao = situacao(frequencia, nota1, trabalho, projeto, notafinal);
           ...
           if( nota1 >= 0 && nota1 <= 10 ){
               ...
               req.setAttribute("nota1", nota1);
                ...
                req.setAttribute("erronota1", "A Nota 1 está no formato errado! Deve ser entre 0 e 10, repita:");
                valido = false;
            } 
           /**
           ...
           if( trabalho >= 0 && trabalho <= 10 ){
               ...
               req.setAttribute("trabalho", trabalho);
                ...
                req.setAttribute("aluno", aluno);
                req.setAttribute("erroTrabalho", "A nota do Trabalho está no formato errado! Deve ser entre 0 e 10, repita:");
                valido = false;
            } 
           ...
           if( projeto >= 0 && projeto <= 10 ){
               ...
               req.setAttribute("projeto", projeto);
                ...
                req.setAttribute("aluno", aluno);
                req.setAttribute("erroProjeto", "A nota do Projeto está no formato errado! Deve ser entre 0 e 10, repita:");
                valido = false;
            } 
           ...
           if( notafinal >= 0 && notafinal <= 10 ){
               ...
               req.setAttribute("notafinal", notafinal);
                ...
                req.setAttribute("aluno", aluno);
                req.setAttribute("erroNotafinal", "A nota da prova final está no formato errado! Deve ser entre 0 e 10, repita:");
                valido = false;
            } 
           ...
           if( frequencia >= 0 && frequencia <= 100 ){
               ...
               req.setAttribute("frequencia", frequencia);
                ...
                req.setAttribute("aluno", aluno);
                req.setAttribute("erroFrequencia", "A frequência está errada! Deve ser entre 0 e 100, repita:");
                valido = false;
            } 
